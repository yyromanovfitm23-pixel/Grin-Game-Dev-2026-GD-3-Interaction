...
namespace Assets.HeroEditor.Common.Scripts.Editor
{
    ...
    {
        //private const string PackageId = "116375";
        //private const string PackageName = "Character Editor [Megapack]";

        private const string PackageId = "90592";
        private const string PackageName = "Character Editor [Fantasy]";
